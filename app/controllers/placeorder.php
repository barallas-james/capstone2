...
$staff_email = 'ecomsoots@gmail.com';
$customer_email = $_SESSION['logged_in_user']['email']; 
// $customer_email = 'barallas.james@gmail.com';           
$subject = 'Soots E-Commerce - Order Confirmation';
$body = '<div style="text-transform:uppercase;">
			<h1>Thank you for buying at Soots E-Commerce</h1>
			<h3>Reference No.: '.$transaction_number.'</h3>
		</div>
		<div>
			<h4>The items you ordered will be shipped to the address: $address</h4>
		</div>';
try {
    //Server settings
    ...
    $mail->Password = 'James4523';                     	  // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom($staff_email, 'Soots');
